...
class SendKafkaMeldingTilDatavarehusTest {
    ...
    companion object {
        ...
        private val stillingEsKlientMock = mockk<StillingEsKlient>()
        private val stillingService = StillingService(stillingEsKlientMock, stillingRepo)
    ...
    fun `Feilsending med Kafka skal oppdatere antallSendtForsøk og sisteSendtForsøk`() {
        every { stillingEsKlientMock.hentStilling(etKandidatutfall.stillingsId) } returns enElasticSearchStilling()
