...
class DatakatalogStatistikkTest {
    ...
    fun `Antall Hull i cv presentert skal sendes`() {
        val expected = jacksonObjectMapper().writeValueAsString(testPlot(
            yaxisText = "Antall",
