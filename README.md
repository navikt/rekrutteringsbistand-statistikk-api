...
Schema-registryet på topicet er bruker ikke BACKWARD avro compability.
Dette kan man se ved å gjøre get-kall mot https://<host>/config/toi.kandidatutfall-value/
API-referanse: https://docs.confluent.io/platform/current/schema-registry/develop/api.html
Backward compability betyr at man ikke får feil ved utvidelse av enums eller nytt felt i kontrakten. Man kan legge til nye verdier, men det vil feile dersom man sender nye verdier/enum før konsumentene har tatt i bruk ny avro.
Så anbefalt rekkefølge er:

- Bruk ny avro i produsent, men ikke send nye verdier. Ny avro publiseres til schema registry ved første nye melding
- Pass på at alle konsumenter bruker ny avro
- Begynn å sende med nye felt/enum verdier
